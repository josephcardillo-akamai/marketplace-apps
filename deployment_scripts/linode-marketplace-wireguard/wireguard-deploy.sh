...
## WireGuard Settings
#<UDF name="wireguard_port" Label="Port" example="51820" default="51820" />
#<UDF name="server_private_ip" Label="Server VPN Network" example="10.0.0.1/24, 172.16.0.1/24, 192.168.1.1/24" Default="10.0.0.1/24" />
#<UDF name="client_public_key" Label="WireGuard Public Key (Client)" default="" />
#<UDF name="client_private_ip" Label="Client VPN IP" example="10.0.0.2/32, 172.16.0.2/32, 192.168.1.2/32" Default="10.0.0.2/32" />
#<UDF name="client_public_ip" Label="Client Public IP (Endpoint)" default="" />
...
export MARKETPLACE_APP="apps/linode-marketplace-wireguard"
